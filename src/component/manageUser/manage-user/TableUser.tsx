    ...
    const confirmSendNoti = async (message: string) => {
        if (userToSendNoti) {
            try {
                ...
                const url = `${BASE_URL}/api/v1/admin/createDirectNoti`;
            ...
            try {
                ...
                const url =
                    userToPromote.role === "USER"
                        ? `${BASE_URL}/api/v1/admin/promoteUser?username=${userToPromote.username}`
                        : `${BASE_URL}/api/v1/admin/demoteUser?username=${userToPromote.username}`;
        ...
        const fetchDataExport = async () => {
            try {
                ...
                const response = await fetch(
                    `${BASE_URL}/api/v1/admin/getAllUser?pageNum=1&pageSize=1000`,
                    {
                        method: "GET",
                        headers: {
                            Authorization: `Bearer ${token}`,
