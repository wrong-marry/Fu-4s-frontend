...
function TableSubject() {
    ...
    useEffect(() => {
        const fetchAllSubject = async () => {
            ...
            try {
                const response = await fetch(
                    `https://api.fu4s.online.175:8080/api/v1/admin/getNumSubject`,
                    {
                        headers: {
        ...
        const fetchActiveSubject = async () => {
            ...
            try {
                const response = await fetch(
                    `https://api.fu4s.online.175:8080/api/v1/admin/getNumSubjectsByType?isActive=true`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
        ...
        const fetchDisabledSubject = async () => {
            ...
            try {
                const response = await fetch(
                    `https://api.fu4s.online.175:8080/api/v1/admin/getNumSubjectsByType?isActive=false`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
    ...
    const confirmDisable = async () => {
        if (subjectToDisable) {
            try {
                const token = localStorage.getItem("token");
                const response = await fetch(
                    `https://api.fu4s.online.175:8080/api/v1/admin/disableSubject?subjectCode=${subjectToDisable.code}`,
                    {
                        method: "PUT",
                        headers: {
                            Authorization: `Bearer ${token}`,
    ...
    const confirmActivate = async () => {
        if (subjectToActivate) {
            try {
                const token = localStorage.getItem("token");
                const response = await fetch(
                    `https://api.fu4s.online.175:8080/api/v1/admin/activeSubject?subjectCode=${subjectToActivate.code}`,
                    {
                        method: "PUT",
                        headers: {
                            Authorization: `Bearer ${token}`,
    ...
    const handleUpdateClick = async () => {
        if (currentSubject) {
            try {
                const token = localStorage.getItem("token");
                await fetch(`https://api.fu4s.online.175:8080/api/v1/admin/updateSubject`, {
                    method: "PUT",
                    headers: {
                        Authorization: `Bearer ${token}`,
                        "Content-Type": "application/json",
    ...
    const handleSaveClick = async () => {
        if (currentSubject) {
            try {
                const token = localStorage.getItem("token");
                const response = await fetch(
                    `https://api.fu4s.online.175:8080/api/v1/admin/createSubject`,
                    {
                        method: "POST",
                        headers: {
                            Authorization: `Bearer ${token}`,
